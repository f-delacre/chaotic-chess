...
public class NetMakeMove : NetMessage
{
    ...
    public int randomPromotionPiece;
    ...
    public override void Serialize(ref DataStreamWriter writer)
    {
        ...
        writer.WriteByte(isPromotion);
        writer.WriteInt(randomPromotionPiece);
    }
    ...
    public override void Deserialize(DataStreamReader reader)
    {
        ...
        isPromotion = reader.ReadByte();
        randomPromotionPiece = reader.ReadInt();
    }
